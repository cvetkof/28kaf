...
function getPropability(counter, step) {
	if (step == 1) {
		...
		if (step == 2) {
			...
			document.querySelectorAll('.forecast-table td')[2].innerHTML = "m<small><sub>0</sub></small> , &xi;<small><i>су</i></small>";
			mass = [{ x: 1, y: jointProbabilityFirst }, { x: 2, y: jointProbabilitySecond }, { x: 3, y: jointProbabilityThird }, { x: 4, y: jointProbabilityFourth }];
			...
			if (step == 3) {
				...
				document.querySelectorAll('.forecast-table td')[5].innerHTML = "m<small><sub>0</sub></small> , &xi;<small><i>су</i></small>";
				document.querySelectorAll('.forecast-table td')[2].innerHTML = "m<small><sub>0</sub></small> , &xi;<small><i>су</i></small> , &xi;<small><i>m</i></small>";
				mass = [{ x: 1, y: jointProbabilityFirst }, { x: 2, y: jointProbabilitySecond }, { x: 3, y: jointProbabilityThird }, { x: 4, y: jointProbabilityFourth }];
				...
				document.querySelectorAll('.forecast-table td')[8].innerHTML = "m<small><sub>0</sub></small> , &xi;<small><i>су</i></small>";
				document.querySelectorAll('.forecast-table td')[5].innerHTML = "m<small><sub>0</sub></small> , &xi;<small><i>су</i></small> , &xi;<small><i>m</i></small>";
				document.querySelectorAll('.forecast-table td')[2].innerHTML = "m<small><sub>0</sub></small> , &xi;<small><i>су</i></small> , &xi;<small><i>m</i></small> , &xi;<small><i>c</i></small>";
				mass = [{ x: 1, y: jointProbabilityFirst }, { x: 2, y: jointProbabilitySecond }, { x: 3, y: jointProbabilityThird }, { x: 4, y: jointProbabilityFourth }];
